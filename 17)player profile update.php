  ...
  <div  class="wrap">
    <div class="Regisration">
      <div class="Regisration-head">
        <h2><span></span>UPDATE PROFILE</h2>
      </div>
      <?php
      include( 'session player.php' );
      $id = $loggedin_session;
      $result = mysqli_query( $mysqli, "SELECT * FROM member WHERE email = '$id'" );
      ...
      if ( $remarks == null and $remarks == "" ) {
          echo ' <div style = "color : white;">Update Here</div> ';
      }
      if ( $remarks == 'success' ) {
          echo ' <div style = "color : white;">Update Success</div> ';
      }
      if ( $remarks == 'failed' ) {
          echo ' <div style = "color : white;">Update Failed!, Email exists</div> ';
      }
      if ( $remarks == 'error' ) {
          echo ' <div style = "color : white;">Update Failed! <br> Error: ' . $_GET[ 'value' ] . ' </div> ';
      } else {
          ?>
      <form class="form" name="reg" action="execute up player.php" onsubmit="return validateForm()" method="post">
