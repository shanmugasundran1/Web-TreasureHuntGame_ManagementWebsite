    ...
    <div class="wrap">
      <div class="Regisration">
        <div class="Regisration-head">
          <h2><span></span>ORGANIZER REGISTRATION</h2>
        </div>
        ...
        if ($remarks == 'success') {
          echo ' <div style="color:white;">Registration Success</div> ';
        }
        if ($remarks == 'failed') {
        ...
        ?>
          <form class="form" name="reg" action="execute organizer.php" onsubmit="return validateForm()" method="post">

            <input type="text" name="email" placeholder="Email Adress" required>
            <input type="password" name="password" placeholder="Password" required>
            <input type="text" name="fname" placeholder="First Name" required>
            <input type="text" name="lname" placeholder="Last Name" required>
	    <input type="text" name="oname" placeholder="Organization" required>
